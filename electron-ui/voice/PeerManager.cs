/*
 * Adapted from LibreMetaverse.Voice.WebRTC/PeerManager.cs
 * Copyright (c) 2025, Sjofn LLC - BSD License
 *
 * Modified for standalone sidecar: GridClient removed.
 */
...
namespace VoiceSidecar
{
    public class PeerManager
    {
        ...
        public PeerManager(Sdl3Audio audioDevice, IVoiceLogger log)
        {
