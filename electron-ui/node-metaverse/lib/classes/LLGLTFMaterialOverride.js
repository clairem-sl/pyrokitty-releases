...
exports.LLGLTFMaterialOverride = void 0;
const UUID_1 = require("./UUID");
class LLGLTFMaterialOverride {
    textures;
    baseColor;
    emissiveFactor;
    metallicFactor;
    ...
    doubleSided;
    textureTransforms;
    static fromFullMaterialJSON(json) {
            ...
            if (obj.textures && Array.isArray(obj.textures) && obj.textures.length > idx) {
                ...
                if (source !== undefined && obj.images && Array.isArray(obj.images) && obj.images.length > source) {
                    ...
                    if ('uri' in img) {
                        ...
                        if (found.uuid === UUID_1.UUID.zero().toString()) {
                            found.uuid = null;
                        }
                    }
                }
                const transform = obj.textures[idx].extensions?.KHR_texture_transform;
                if (transform) {
...
exports.LLGLTFMaterialOverride = LLGLTFMaterialOverride;
//# sourceMappingURL=LLGLTFMaterialOverride.js.map