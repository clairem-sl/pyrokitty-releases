    ...
    protected objectUpdateCompressed(objectUpdateCompressed: ObjectUpdateCompressedMessage): void
    {
        for (const obj of objectUpdateCompressed.ObjectData)
        {
            ...
            else
            {
                ...
                o.PathTwist = Utils.unpackPathTwist(buf.readInt8(pos++));
                o.PathTwistBegin = Utils.unpackPathTwist(buf.readInt8(pos++));
                o.PathRadiusOffset = Utils.unpackPathTwist(buf.readInt8(pos++));
                o.PathTaperX = Utils.unpackPathTaper(buf.readInt8(pos++));
                o.PathTaperY = Utils.unpackPathTaper(buf.readInt8(pos++));
                o.PathRevolutions = Utils.unpackPathRevolutions(buf.readUInt8(pos++));
                o.PathSkew = Utils.unpackPathTwist(buf.readInt8(pos++));
