...
class ParticleSystem {
    startGlow = 0.0;
    endGlow = 0.0;
    blendFuncSource = BlendFunc_1.BlendFunc.SourceAlpha;
    blendFuncDest = BlendFunc_1.BlendFunc.OneMinusSourceAlpha;
    crc = 0;
    pattern = SourcePattern_1.SourcePattern.None;
    maxAge = 0.0;
    startAge = 0.0;
    innerAngle = 0.0;
    outerAngle = 0.0;
    ...
    burstSpeedMax = 0.0;
    burstPartCount = 0;
    angularVelocity = Vector3_1.Vector3.getZero();
    acceleration = Vector3_1.Vector3.getZero();
    texture = UUID_1.UUID.zero();
    target = UUID_1.UUID.zero();
    dataFlags = ParticleDataFlags_1.ParticleDataFlags.None;
    partMaxAge = 0.0;
    startColor = Color4_1.Color4.black;
    endColor = Color4_1.Color4.black;
    startScaleX = 0.0;
    startScaleY = 0.0;
    endScaleX = 0.0;
    endScaleY = 0.0;
