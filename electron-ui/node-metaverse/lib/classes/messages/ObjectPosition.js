...
class ObjectPositionMessage {
    name = 'ObjectPosition';
    messageFlags = MessageFlags_1.MessageFlags.Zerocoded | MessageFlags_1.MessageFlags.Deprecated | MessageFlags_1.MessageFlags.FrequencyMedium;
    id = Message_1.Message.ObjectPosition;
    AgentData;
    ObjectData;
    getSize() {
