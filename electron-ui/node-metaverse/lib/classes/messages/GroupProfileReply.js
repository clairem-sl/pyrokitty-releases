...
class GroupProfileReplyMessage {
    ...
    id = Message_1.Message.GroupProfileReply;
    AgentData;
    GroupData;
    getSize() {
    ...
    readFromBuffer(buf, pos) {
        ...
        const newObjGroupData = {
            ...
            PowersMask: long_1.default.ZERO,
        ...
        pos += varLength;
        newObjGroupData['PowersMask'] = new long_1.default(buf.readInt32LE(pos), buf.readInt32LE(pos + 4));
        pos += 8;
