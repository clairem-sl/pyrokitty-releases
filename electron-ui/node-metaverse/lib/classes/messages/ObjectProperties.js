...
class ObjectPropertiesMessage {
    ...
    messageFlags = MessageFlags_1.MessageFlags.Trusted | MessageFlags_1.MessageFlags.Zerocoded | MessageFlags_1.MessageFlags.FrequencyMedium;
    id = Message_1.Message.ObjectProperties;
    ObjectData;
    getSize() {
    ...
    readFromBuffer(buf, pos) {
        ...
        for (let i = 0; i < count; i++) {
            const newObjObjectData = {
                ...
                CreationDate: long_1.default.ZERO,
                BaseMask: 0,
                OwnerMask: 0,
                GroupMask: 0,
                EveryoneMask: 0,
            ...
            pos += 16;
            newObjObjectData['CreationDate'] = new long_1.default(buf.readInt32LE(pos), buf.readInt32LE(pos + 4));
            pos += 8;
