...
class RegionHandshakeMessage {
    ...
    id = Message_1.Message.RegionHandshake;
    RegionInfo;
    RegionInfo2;
    RegionInfo3;
    RegionInfo4;
    ...
    readFromBuffer(buf, pos) {
        ...
        for (let i = 0; i < count; i++) {
            const newObjRegionInfo4 = {
                ...
                RegionProtocols: long_1.default.ZERO
            };
            newObjRegionInfo4['RegionFlagsExtended'] = new long_1.default(buf.readInt32LE(pos), buf.readInt32LE(pos + 4));
            pos += 8;
            newObjRegionInfo4['RegionProtocols'] = new long_1.default(buf.readInt32LE(pos), buf.readInt32LE(pos + 4));
            pos += 8;
