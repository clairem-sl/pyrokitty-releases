...
export class Circuit
{
    ...
    /**
     * Get the local UDP port this circuit is bound to.
     * Returns 0 if the socket hasn't been bound yet (no packets sent).
     */
     ...
     * This is used for session continuation handoff where the viewer
     * needs to continue from the same sequence number.
     */
